...
public class TestPage {
    ...
    public void testPage() {
        ViewInteraction textView = onView(allOf(withId(R.id.section_label), isDisplayed()));
        ...
        ViewInteraction textView2 = onView(allOf(withId(R.id.section_label), isDisplayed()));
